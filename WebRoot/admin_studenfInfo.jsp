...
<div class="container">
	<div class="besttop" style="height: 90px;">
		<h1 class='page-header' style="display: inline; line-height: 90px;">管理员——学生管理</h1>
		...
		<table class='table table-striped table-bordered table-hover table-condensed'>
			...
			<c:forEach items="${students}" var="student">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/GetStudentInfo?sno=${student.sno}">详情</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
