...
<body style="overflow: hidden;">
	<div class="container">
		<div class="besttop" style="height: 90px;">
			...
			<a href="${pageContext.request.contextPath}/teacher.jsp" target="_self" class="glyphicon glyphicon-log-out" style="display: inline; margin-left: 600px; cursor: pointer;" >回到教师个人中心</a>
		</div>
 		<p style="color: red">${msg}</p>
 <form id="defaultForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/alterInfo?role=teacher">
       <!-- 角色 -->
       ...
       <div class="form-group">
           ...
           <div class="col-lg-5">
               <input type="text" class="form-control" name="tno" value="${param.usercode}" disabled="disabled"/>
           </div>
       </div>
		...
		<div class="form-group">
         ...
         <div class="form-group">
             <div class="col-lg-9 col-lg-offset-3">
                 <button type="submit" class="btn btn-primary" name="signup" onclick="getValue()"  value="Sign up" style="width:120px;margin-left:130px; font-size:17px;">修改</button>
             </div>
         </div>
     </form>
     </div>
