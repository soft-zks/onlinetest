	...
	<div class="container">
		<div class="besttop" style="height: 90px;">
	 	...
	 	<p style="color: red">${msg}</p>
	 	 <form id="defaultForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/alterInfo?role=admin">
	       <!-- 角色 -->
	       <input type="hidden" class="form-control" name="role" value="${role}"/>
	       <!-- 角色 -->
	        <!-- 账号 -->
	       <input type="hidden" class="form-control" name="usercode" value="${login.usercode}"/>
	       <!-- 账号-->
	       <div class="form-group">
	           <label class="col-lg-3 control-label">用户名</label>
	           <div class="col-lg-5">
	               <input type="text" class="form-control" name="ano" value="${login.usercode}" disabled="disabled"/>
	           </div>
	       </div>
